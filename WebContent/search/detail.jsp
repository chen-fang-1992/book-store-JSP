...
<%if(source.equals("results")){ %>
<form action="../search/results.jsp">
	<input type="submit" value="Back"/>
	<input type="hidden" name="page" value="<%=pageNum%>"/>
</form>
<%} else if(source.equals("itemmanage")){%>
<form action="../admin/item_manage.jsp">
	<input type="submit" value="Back"/>
	<input type="hidden" name="page" value="<%=pageNum%>"/>
</form>
<% } else if(source.equals("customer_detail")){%>
<form action="../admin/customer_detail.jsp">
	<input type="submit" value="Back"/>
	<input type="hidden" name="page" value="<%=pageNum%>"/>
</form>
<% }%>
